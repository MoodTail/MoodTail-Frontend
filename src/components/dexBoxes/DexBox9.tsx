...
export default function DexBox9({
  unlocked = false,
  onClick,
}: {
  unlocked?: boolean;
  ...
  if (unlocked) {
    return (
      ...
      >
        <img src={drink8} alt="" style={{ width: "70%", height: "70%", objectFit: "contain" }} />
        <span style={{ fontSize: 10.5, fontWeight: 700, color: COLORS.orange }}>평론가</span>
      </button>
    );
  }
