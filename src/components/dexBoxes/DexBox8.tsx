...
export default function DexBox8({
  unlocked = false,
  onClick,
}: {
  unlocked?: boolean;
  ...
  if (unlocked) {
    return (
      ...
      >
        <img src={drink7} alt="" style={{ width: "70%", height: "70%", objectFit: "contain" }} />
        <span style={{ fontSize: 10.5, fontWeight: 700, color: COLORS.orange }}>분석가</span>
      </button>
    );
  }
